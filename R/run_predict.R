...
#' The output files are be the standard output files produced by predictf90
#'
...
run_predict <- function(path_2_execs) {
  ...
  mac_terminal_command(command = paste0(path_2_execs, "predictf90 renf90.par"), logfile = "predict_all.log")
