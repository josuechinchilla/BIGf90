...
```{r}
write_geno(
  ped  = "mydata.ped",     # PLINK --recode12 output (no header, 6 lead columns)
  file = "genotypes.geno", # BLUPf90 genotype file to create
  map  = "mydata.map",     # optional: checks the locus count matches
